    ...
    <main className="min-h-screen">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="md:w-1/2">
              ...
              <div className="flex flex-wrap gap-4 fade-in delay-200">
                ...
                <Link 
                  href="/map" 
                  className="px-5 py-3 bg-white text-blue-600 border border-blue-200 rounded-lg font-medium hover:bg-blue-50 transition hover-scale"
                >
                  Rota Planlayıcı
                </Link>
              </div>
            ...
            <div className="md:w-1/2 relative fade-in delay-300">
              <div className="bg-white p-3 rounded-xl shadow-xl hover-lift">
                <div 
                  className="w-full h-64 bg-gradient-to-br from-blue-100 to-indigo-200 rounded-lg flex items-center justify-center overflow-hidden"
                >
                  <div className="text-blue-600 relative">
                    <div className="absolute w-24 h-24 bg-blue-200 rounded-full -top-12 -left-12 opacity-50"></div>
                    <div className="absolute w-16 h-16 bg-green-200 rounded-full -bottom-8 -right-8 opacity-50"></div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="bg-blue-50 rounded-xl p-6 transition-all hover-lift fade-in delay-100">
            ...
            {/* Feature 2 */}
            <div className="bg-indigo-50 rounded-xl p-6 transition-all hover-lift fade-in delay-200">
            ...
            {/* Feature 3 */}
            <div className="bg-green-50 rounded-xl p-6 transition-all hover-lift fade-in delay-300">
            ...
            {/* Feature 4 */}
            <div className="bg-red-50 rounded-xl p-6 transition-all hover-lift fade-in delay-200">
            ...
            {/* Feature 5 */}
            <div className="bg-purple-50 rounded-xl p-6 transition-all hover-lift fade-in delay-300">
            ...
            {/* Feature 6 */}
            <div className="bg-yellow-50 rounded-xl p-6 transition-all hover-lift fade-in delay-400">
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-indigo-700 text-white relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-8 text-center relative z-10">
          ...
          <Link 
            href="/planner" 
            className="px-6 py-3 bg-white text-blue-600 rounded-lg font-medium shadow-md hover:bg-blue-50 transition inline-block hover-lift fade-in delay-200"
          >
